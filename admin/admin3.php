...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $saldo_corrente = isset($data['SaldoAttuale3']) ? floatval($data['SaldoAttuale3']) : 0;
  $nuovo_saldo = $saldo_corrente - $saldoDaSottrarre;

  // Aggiorna il saldo nel file JSON
  $data['SaldoAttuale3'] = $nuovo_saldo;
...
$saldo_corrente = number_format($data['SaldoAttuale3'] ?? 0, 2, ',', '.');
