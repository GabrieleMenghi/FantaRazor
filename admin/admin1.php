...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $saldo_corrente = isset($data['SaldoAttuale1']) ? floatval($data['SaldoAttuale1']) : 0;
  $nuovo_saldo = $saldo_corrente - $saldoDaSottrarre;

  // Aggiorna il saldo nel file JSON
  $data['SaldoAttuale1'] = $nuovo_saldo;
...
$saldo_corrente = number_format($data['SaldoAttuale1'] ?? 0, 2, ',', '.');
